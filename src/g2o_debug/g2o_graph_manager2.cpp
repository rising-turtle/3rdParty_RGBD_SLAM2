...
///This file contains methods of the G2O_GraphManager class without extra 
///dependencies (except for the class header).
//
G2O_GraphManager::~G2O_GraphManager(){}
/*
void G2O_GraphManager::toggleMapping(bool mappingOn){
...
bool G2O_GraphManager::isBusy(){
  return (batch_processing_runs_ || process_node_runs_ );
}

void G2O_GraphManager::clearPointClouds() {
...
void G2O_GraphManager::clearPointCloud(pointcloud_type const * pc) {
...
void G2O_GraphManager::deleteLastFrame(){
    if(graph_.size() <= 1) {
...
//WARNING: Dangerous
void G2O_GraphManager::deleteFeatureInformation() {
...
void G2O_GraphManager::setEmpiricalCovariancesForEdgeSet(EdgeSet& edges){
...
void G2O_GraphManager::setEmpiricalCovariances(){
